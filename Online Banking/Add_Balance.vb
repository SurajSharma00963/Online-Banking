...
Public Class Add_Balance
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Deposit.Click
    ...
    Private Sub Account_no_TextChanged(sender As Object, e As EventArgs) Handles Account_no.TextChanged
